...
API_KEY = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiIsImtpZCI6IjI4YTMxOGY3LTAwMDAtYTFlYi03ZmExLTJjNzQzM2M2Y2NhNSJ9..dWSXxzEWkrg8lT3yEgU1gfDFAm9SerrxvjA5DOrDVm_ayFJ5r0_jAWBvjrNnqjW3Efx4AaPyfppwOwgPP8_JBQ"
...
def make_api_request(endpoint):
    ...
    try:
        ...
        if e.code == 403:
            ...
            print("💡 Tu IP debe estar registrada específicamente: 201.178.229.54")
        elif e.code == 404:
        ...
        function showPlayersTab(tabType) {
            ...
            players.forEach(function(player, index) {
                ...
                row.innerHTML = 
                    ...
                    '<td style="text-align: center; font-weight: 600; color: #d32f2f;">' + formatNumber(player.donationsReceived) + '</td>' +
